    ...
    void Display()
    {
        ...
        else
        {
            ...
            if(status)
            {
                ...
                cout<<"4.Doctor's city               :"<<arr[i].city<<"\n";
 ...
 void patient :: add_pat_info()
   {
        ...
        cin>>arr[docid1].dis;
        cout<<" 5. Enter Patient's Room Charge                        :";
        cin>>arr[docid1].charg;
        cout<<" 6. Enter Patient's Medicine charge                   :";
        cin>>arr[docid1].bill;
        docid1++;
        counter++;
        cout<<"\n";
...
int main()
{
    ...
    if(ch1==1)
    {
         ...
         cout<<"   3.   Generate    Patient's   Bill       "<<endl;
         cout<<"   4.   EXIT                               "<<"\n";
        ...
        case 2:
             cout<<"\n\n";
               ...
               cout<<       "3. Total Number of Patient's  in Hospital     "<<endl;
               cout<<       "4. EXIT                                      "<<"\n";
